...
import au.edu.alveo.client.JsonApi.JsonItemList;
import au.edu.alveo.client.JsonApi.VersionResult;
import au.edu.alveo.client.entity.*;
...
//		// instead of the more usual ClientBuilder.newClient(), we do this to specify the engine:
	...
	private class ItemListImpl implements ItemList {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.ItemList#getUri()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.ItemList#itemUris()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.ItemList#name()
		 */
		public String name() {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.ItemList#numItems()
		 */
		public int numItems() {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.ItemList#getCatalogItems()
		 */
	...
	private class ItemImpl extends JsonLdDerivedObject implements Item {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.Item#documents()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.Item#getUri()
		 */
		public String getUri() {
			return uri;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.Item#getPrimaryTextUrl()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.Item#primaryText()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.Item#getMetadata()
		 */
	...
	private class DocumentImpl extends JsonLdDerivedObject implements Document {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.Document#getType()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see au.edu.alveo.client.entity.Document#getSize()
		 */
		@Nullable
	...
	private class TextDocumentImpl extends DocumentDelegator implements TextDocument {
		 ...
		 * (non-Javadoc)
		 *
		 * @see au.edu.alveo.client.entity.TextDocument#rawText()
		 */
